<link rel="shortcuticon" href="<?= base_url('assets/'); ?>images/stars.png">
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/'); ?>styles/bootstrap-4.1.3/bootstrap.css">
